...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['mobile'])) {
    $createNotification = $ads->CreateMngNotifiForMobile($_POST);
}
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['updateMobile'])) {
    $updateNotification = $ads->updateMngNotifiForMobile($_POST);
}

$getMobileNotification = $ads->getMobileNotification();
...
?>
      <div class="row">
        <div class="col-md-7 grid-margin ">
          ...
          <a href="notification.php" class="btn btn-success">Manage Notifications</a>
          <div class="card-body">

  <?php
if ($getMobileNotification) {
    while ($mResult = $getMobileNotification->fetch_assoc()) {
        ?>
           <div class="form">
                <form action="" method="post">
                  <div class="form-group">
                    <input type="hidden" name="type" value="mobile" >
                    <label for="api_key">Onsignal Api Key</label>
                    <input type="text" class="form-control" name="mb_api_key" id="" value="<?=$mResult['api_key'];?>">
                  </div>
                  <div class="form-group">
                    <label for="api_key">Onsignal Api ID</label>
                    <input type="text" class="form-control" name="mb_api_id" id="" value="<?=$mResult['api_id'];?>">
                  </div>
                  <button class="btn btn-success mt-3" type="submit" name="updateMobile">Update</button>
                </form>
              </div>
              <?php }} else {?>
            <div class="form">
              <form action="" method="post">
                <div class="form-group">
                  <input type="hidden" name="type" value="mobile">
                  <label for="api_key">Onsignal Api Key</label>
                  <input type="text" class="form-control" name="mb_api_key" id="">
                </div>
                <div class="form-group">
                  <label for="api_key">Onsignal Api ID</label>
                  <input type="text" class="form-control" name="mb_api_id" id="">
                </div>
                <button class="btn btn-success mt-3" type="submit" name="mobile">Save</button>
              </form>
            </div>
<?php }?>
          </div>
