                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 grid-margin ">
                                                    ...
                                                    <div class="add-content">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="form-check form-switch">
                                                                        <input checked="" class="form-check-input" name="gg_add_type" type="checkbox" id="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="ad-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="gg_admob_id" class="form-control create-form" id="googleBannerAdmob" value="asdf update ">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="googleInteresticialAdmob">Interesticial Admob ID</label>
                                                                <input type="text" name="gg_interesticial_admob_id" class="form-control create-form" id="googleInteresticialAdmob" value="asdf fasdf">
                                                            </div>
                                                            <div class="interesticial-details">
                                                                <div class="form-group">
                                                                    <label for="googleInteresticialAdmobClick">Interesticial Admob Click</label>
                                                                    <input type="number" name="gg_interesticial_admob_click" value="1" class="form-control create-form" id="googleInteresticialAdmobClick">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="googleNativeAdmob">Native Admob ID</label>
                                                                <input type="text" name="gg_native_admob_id" class="form-control create-form" id="googleNativeAdmob" value="1">
                                                            </div>
                                                            <div class="native-details">
                                                                <div class="form-group">
                                                                    <label for="googlNativeAddPerVideo">Native Ad Per Video (You May Also
                            Like)</label>
                                                                    <input type="number" name="gg_native_ad_per_video_like" value="1" class="form-control create-form" id="googlNativeAddPerVideo">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="googlNativeAddPerVideoSeries">Native Ad Per Video (For
                            Series)</label>
                                                                    <input type="number" name="gg_native_ad_per_video_series" value="1" class="form-control create-form" id="googlNativeAddPerVideoSeries">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="add-content">
                                                        <div class="ad-title-fb">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" name="fb_add_type" type="checkbox" id="facebookStatus">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="ad-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="fb_admob_id" class="form-control create-form" id="facebookBannerAdmob" value="asdf">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="facebookInteresticialAdmob">Interesticial Admob ID</label>
                                                                <input type="text" name="fb_interesticial_admob_id" value="asdf" class="form-control create-form" id="facebookInteresticialAdmob">
                                                            </div>
                                                            <div class="interesticial-details">
                                                                <div class="form-group">
                                                                    <label for="facebookInteresticialAdmobClick">Interesticial Admob Click</label>
                                                                    <input type="number" name="fb_interesticial_admob_click" value="1" class="form-control create-form" id="facebookInteresticialAdmobClick">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="facebookNativeAdmob">Native Admob ID</label>
                                                                <input type="text" name="fb_native_admob_id" class="form-control create-form" id="facebookNativeAdmob" value="1">
                                                            </div>
                            ...
                            Like)</label>
                                                                    <input type="number" name="fb_native_ad_per_video_like" value="1" class="form-control create-form" id="facebookNativeAddPerVideo">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="facebookNativeAddPerVideoSeries">Native Ad Per Video (For
                            Series)</label>
                                                                    <input type="number" name="fb_native_ad_per_video_series" value="1" class="form-control create-form" id="facebookNativeAddPerVideoSeries">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="add-content">
                                                        <div class="ad-title">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" name="cs_add_type" type="checkbox" id="customStatus">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="ad-body">
                                                            <div class="row">
                                                                <div class="col-md-6 custom-banner">
                                                                    <div class="form-group">
                                                                        <img src="uploads/a3a05f20681.png" height="50" width="80" alt=""> <br>
                                                                    ...
                                                                    <div class="form-group margin-top-20">
                                                                        ...
                                                                        <input type="text" name="cs_banner_admob_link" value="asdf" class="form-control create-form" id="customBannerAdmob">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 custom-interseticial">

                                                                    <div class="form-group">
                                                                        <img src="uploads/bdc16bffa22.png" height="50" width="80" alt=""> <br>
                                                                        <label for="interesticialImage">Upload Interesticial Image</label><br>
                                                                        <input type="file" name="cs_interesticial_image" class="form-control-file" id="interesticialImage">
                                                                    </div>

                                                                    <div class="form-group margin-top-20">
                                                                        <label for="interesticialBannerLink">Interesticial AD Link</label>
                                                                        <input type="text" name="cs_interesticial_ad_link" value="asdf" class="form-control create-form" id="interesticialBannerLink">
                                                                    </div>


                                                                    <div class="form-group">
                                                                        <label for="customInteresticialAdmobClick">Interesticial Admob Click</label>
                                                                        <input type="number" name="cs_Interesticial_admob_click" value="1" class="form-control create-form" id="customInteresticialAdmobClick">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6 native-interseticial">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <img src="uploads/a22e04d3733.png" height="50" width="80" alt=""> <br>
                                                                    ...
                                                                    <div class="form-group margin-top-20">
                                                                        ...
                                                                        <input type="text" name="cs_native_ad_link" value="asdfasdf" class="form-control create-form" id="nativeNativeAdmob">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="customNativeAddPerVideo">Native Ad Per Video (You May Also
                              Like)</label>
                                                                        <input type="number" name="cs_native_ad_per_video_like" value="1" class="form-control create-form" id="customNativeAddPerVideo">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="customNativeAddPerVideoSeries">Native Ad Per Video (For
                              Series)</label>
                                                                        <input type="number" name="cs_native_ad_per_video_series" value="1" class="form-control create-form" id="customNativeAddPerVideoSeries">
                                                                    </div>
                                                    ...
                                                    <div class="add-content">
                                                        <div class="ad-title-bk">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" name="startup_add_type" type="checkbox" id="startupStatus">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 startup-banner">
                                                                    ...
                                                                    <div class="form-group margin-top-20">
                                                                        ...
                                                                        <input type="text" name="startup_ad_id" value="sadfasdf" class="form-control create-form" id="startupBannerAdmob">
                                                                    </div>
