...
if (isset($_GET['delNoti'])) {
    $delId     = $_GET['delNoti'];
    $dleteNoti = $ads->NotidicationDel($delId);
}
...
?>
<h3>Notifications</h3>
                            <a href="manage_notification.php" class="btn btn-success">Manage Notification</a>
            <div class="row">
                ...
                <div class="col-md-10 grid-margin ">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" style="width: 15%;">Video Title</th>
                                <th scope="col" style="width: 15%;">Notification Date</th>
                                <th scope="col" style="width: 50%;">Notification</th>
                        ...
                        <tbody>
                            <?php
if ($getNotification) {
    while ($result = $getNotification->fetch_assoc()) {
        ?>
                            <tr>
                                <td scope="row"><?=$result['title'];?></td>
                                <td><?=$result['date'];?></td>
                                <td><?=$result['noti_desc'];?></td>
                                <td><a href="?delNoti=<?=$result['id'];?>" class="btn btn-danger">Delete</a></td>
                            </tr>
                            <?php }}?>
