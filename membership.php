...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          ...
          ">
                <a class="navbar-brand brand-logo " href="index.php"> <i class="fa fa-user" aria-hidden="true"></i> ADMIN
                </a>
            </div>
            <div class="
            navbar-menu-wrapper
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 grid-margin ">
                            <div class="stretch-card">
                                ...
                                <input type="date" class="date" name="date" id="" placeholder="date">
                            </div>

                            <p class="perag">Today’s Download</p>
                            <p class="count">10,020</p>
                            <p class="percent"><i class="fa fa-caret-up" aria-hidden="true"></i> +2.1 %</p>
